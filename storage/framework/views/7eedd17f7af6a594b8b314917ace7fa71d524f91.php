...
<?php $__env->startSection('content'); ?>
    <div class="flex justify-between">
        ...
        <a href="<?php echo e(route('calculate-loan.index')); ?>" class="inline-block rounded bg-slate-400 px-7 pt-3 pb-2.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]">Next</a>
    </div>
    <br />
    <?php echo Form::open(['id' => 'calculate_loan', 'class' => 'form-horizontal', 'route' => 'lcg.store']); ?>
    ...
    <br />
    <h2 class="text-slate-300">Please fill to check out the encrypted text and decrypted text.</h2>
    <?php echo Form::open(['id' => 'calculate_loan', 'class' => 'form-horizontal', 'route' => 'lcg.update']); ?>

        <?php echo csrf_field(); ?>
        <?php echo method_field('patch'); ?>

        <div class="form-group relative mb-3 xl:w-96">
            <?php echo Form::text('plain_text', null, ['class' => 'peer m-0 block h-[58px] w-full rounded border border-solid border-neutral-300 bg-white bg-clip-padding py-4 px-3 text-base font-normal leading-tight text-neutral-700 ease-in-out placeholder:text-transparent focus:border-primary focus:bg-white focus:pt-[1.625rem] focus:pb-[0.625rem] focus:text-neutral-700 focus:shadow-te-primary focus:outline-none dark:bg-neutral-800 dark:text-neutral-200 [&:not(:placeholder-shown)]:pt-[1.625rem] [&:not(:placeholder-shown)]:pb-[0.625rem]', 'placeholder' => 'Plain Text']); ?>

            <?php echo Form::label('plain_text', 'Plain Text', ['class' => 'pointer-events-none absolute top-0 left-0 origin-[0_0] border border-solid border-transparent py-4 px-3 text-neutral-700 transition-[opacity,_transform] duration-100 ease-in-out peer-focus:translate-x-[0.15rem] peer-focus:-translate-y-2 peer-focus:scale-[0.85] peer-focus:opacity-[0.65] peer-[:not(:placeholder-shown)]:translate-x-[0.15rem] peer-[:not(:placeholder-shown)]:-translate-y-2 peer-[:not(:placeholder-shown)]:scale-[0.85] peer-[:not(:placeholder-shown)]:opacity-[0.65] motion-reduce:transition-none dark:text-neutral-200 peer-focus:text-neutral-900']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\learning\fortitude_test\resources\views/lcg.blade.php ENDPATH**/ ?>