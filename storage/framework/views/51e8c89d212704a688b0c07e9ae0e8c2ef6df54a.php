...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['id' => 'calculate_loan', 'class' => 'form-horizontal', 'route' => 'check-digit.store']); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <br />
    <h2 class="text-slate-300">Click on the check to find out which check digit occurs with the highest frequency from a range 1 to <?php echo e(number_format(1000000, 0, '.', ',')); ?>.</h2>
    <?php echo Form::open(['id' => 'calculate_loan', 'class' => 'form-horizontal', 'route' => 'check-digit.update']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\learning\fortitude_test\resources\views/check-digit.blade.php ENDPATH**/ ?>